...
* [x] Submitted as a new email, subject "Senior Quality Assurance Engineer – Take-Home Submission"
* [x] README Setup + run commands verified from a clean clone
...
* [x] At least one assertion wired into an LLM-eval framework, running as part of the suite
* [x] `artifacts/ux-review.md` (≤ 400 words, desktop + mobile, post-signup, 3–5 prioritized improvements)
* [x] `artifacts/data-checks.md` (≤ 300 words + SQL)
* [x] `artifacts/ai-workflow.md` (≤ 300 words, all 4 questions answered)
* [x] `artifacts/report/` included
* [x] `artifacts/demo.mp4` (60–90 sec, narrated)
